...
general_settings = OrderedDict((
    ...
    ('save_subdir', "stage2/031f_05_08__eval/dice/lesion"),
    ('load_subpath', "stage2/031f_05_08/best_weights_dice.hdf5.0"),
    ('random_seed', 1234),
    ('num_train', 100),
    ('layers_to_not_freeze', final_bn+branch1_bn+branch0_bn),
...
data_gen_kwargs = OrderedDict((
    ('data_path', os.path.join("/data/TransientData/Candela/",
                                "lits_challenge/data_lesion.zarr")),
    ('nb_io_workers', 1),
    ('nb_proc_workers', 4),
    ('downscale', True)
    ))
