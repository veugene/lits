...
general_settings = OrderedDict((
    ('results_dir', "/home/imagia/eugene.vorontsov-home/Experiments"
                    "/lits/results"),
    ('save_subdir', "stage3/029f_01-3"),
    ('load_subpath', "stage2/029f_01/best_weights_ldice.hdf5"),
    ('random_seed', 1234),
    ('num_train', 100),
...
data_gen_kwargs = OrderedDict((
    ('data_path', "/data/TransientData/Candela/"
